...
static char const * const bs_ba[]={
	...
	[T_CONFIG_BINMODE_SELECT_1]="SUMP logic analyzer",
	[T_CONFIG_BINMODE_SELECT_2]="Henry's beautiful Protocol Buffer",
	[T_CONFIG_BINMODE_SELECT_3]="Ian's dirty IO mode",
	[T_CONFIG_BINMODE_SELECT_4]="PICO probe",
	[T_CONFIG_BINMODE_SELECT_5]="DirtyJTAG",
