...
const bp_mode_t modes[MAXPROTO]={
    ...
    [BP_MODE_DUMMY2] = {
        ...
        dummy2_stop,				// stop
        dummy2_stop,				// stop with read
        dummy2_write,				// send(/read) max 32 bit
        ...
        dummy2_periodic,				// service to regular poll whether a byte ahs arrived
        dummy2_macro,				// macro
        ...
        dummy2_help,				// display small help about the protocol
        dummy2_commands,             // mode specific commands
        &dummy2_commands_count,      // mode specific commands count    
        "DUMMY2",				// friendly name (promptname)
    }
#endif
#ifdef BP_USE_SWI2C // BUGBUG -- This define doesn't exist in modes.h?
    [SWI2C] = {
        SWI2C_start,				// start
