...
static char const * const en_us[]={
	...
	//EEPROM command help
	[T_HELP_EEPROM]="read, write and erase 24XX series I2C EEPROM chips",
	[T_HELP_EEPROM_DUMP]="Show contents",
