...
//refresh every 500ms, "-"" means reset time at beginning of interrupt
#define BP_LCD_REFRESH_RATE_MS -500
...
#define FLASH_STORAGE_CS	31
#define BP_SPI_CDI			32
#define DISPLAY_BACKLIGHT	33
#define BP_SPI_CLK			34
#define BP_SPI_CDO			35
...
// #define PSU_PWM_VREG_ADJ		44
// #define PSU_PWM_CURRENT_ADJ	45

// One pins for front buttons
#define EXT1				44
