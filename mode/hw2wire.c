...
uint32_t hw2wire_setup_exc(void){
	pio_hw2wire_init(M_2WIRE_PIO, 3, bio2bufiopin[M_2WIRE_SDA], bio2bufiopin[M_2WIRE_SCL], bio2bufdirpin[M_2WIRE_SDA], bio2bufdirpin[M_2WIRE_SCL], hw2wire_mode_config.baudrate);
