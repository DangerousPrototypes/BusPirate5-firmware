...
void hw_pin_defaults(void) {
    ...
    */
    ...
    ioexp_in_out(IOEXP_CURRENT_FUSE_DETECT, IOEXP_RES_1M |IOEXP_DISPLAY_BACKLIGHT | IOEXP_DISPLAY_RESET | IOEXP_CURRENT_RESET | IOEXP_CURRENT_EN | IOEXP_CURRENT_EN_OVERRIDE);
    // FALA pin init
