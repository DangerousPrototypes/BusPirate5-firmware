...
#define BP_HARDWARE_VERSION "Untitled Bus Pirate REV4"
...
//CURRENT SENSE is attached to a seperate ADC, not through the mux
...
//convert raw ADC to volts, for pin with a /2 resisor divider (MUX inputs)
