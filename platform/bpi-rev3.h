...
#define BP_HARDWARE_VERSION "Untitled Bus Pirate REV3"
...
#define CURRENT_DETECT 29 //25 This pin was not connected in rev3, using the usb detect pin instead
...
// A 74HCT4067 selects one of 16 analog sources to measure (voltage is divided by 2 with a buffered resistor divider)
#define MUX_BPIO0 0
#define MUX_BPIO1 1
#define MUX_BPIO2 2
#define MUX_BPIO3 3
