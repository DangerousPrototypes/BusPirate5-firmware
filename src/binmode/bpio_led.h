/**
 * @file bpio_led.h
 * @brief BPIO LED protocol transaction handler.
 * @details Provides binary protocol LED transaction and configuration.
 */
...
/**
 * @brief Configure LED mode for BPIO.
