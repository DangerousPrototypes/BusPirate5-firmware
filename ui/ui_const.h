...
static const char ui_const_freq_slugs[][4]=
{
	"ns", "us", "ms", "hz", "khz", "mhz", "%"
};
...
// global constants
static const char ui_const_bit_orders[][4] ={
    "MSB",
    "LSB"
};

static const char ui_const_pin_states[][6] ={
    "OFF",
    "ON",
    "GND",
    "PWM",
...
static const char ui_const_display_formats[][6] ={
    "Auto",
    "HEX",
    "DEC",
    //"OCT",
